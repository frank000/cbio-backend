...
public class CalendarGoogleServiceImpl implements CalendarGoogleService {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
            throws IOException {
        // Load client secrets.
        InputStream in = CalendarGoogleServiceImpl.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    public void executa(String id) throws IOException, GeneralSecurityException {
